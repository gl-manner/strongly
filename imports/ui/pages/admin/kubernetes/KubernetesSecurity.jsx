  ...
  return (
    <div className="kubernetes-security">
      <div className="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
          <h4 className="mb-3 mb-md-0">Kubernetes Security Policies</h4>
        </div>
      </div>
        ...
        <div className="col-12 grid-margin stretch-card">
          <div className="card">
            <div className="card-body text-center py-5">
              ...
              <h5 className="mb-3">Security Policies Coming Soon</h5>
              <p className="mb-4">The Kubernetes Security Policies interface is currently under development.</p>
            </div>
          </div>
        </div>
      </div>
